...
public abstract class Recital {
    ...
    public Recital(String unNom, int unaDimF){
        nomB = unNom;
        lista = new String[unaDimF];
        dimF = unaDimF;
    }
    ...
    public String actuar(){
        ...
        for (int i = 0; i < dimF; i++)
            aux = aux + "y ahora tocaremos: " + lista[i];
        return aux;
    }
    
    public abstract String actuarDiferente();
