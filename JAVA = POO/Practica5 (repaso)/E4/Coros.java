...
public abstract class Coros {
    ...
    public Coros(String unNom, Director unD){
        setNomD(unNom);
        D = unD;
    }
    ...
    public abstract void agregarCorista(Corista unC);
    
    public abstract boolean lleno();
    
    public abstract String bienFormado();
    
    public String toString(){
        String aux = getNomD() + ", datos del director: " + D.toString();
        return aux;
    }
